          ...
          <Row>
            <Col lg="6" md="6" sm="6">
              <div className="header__top__left">
                ...
                <span className="header__top__help">
                  <i class="ri-phone-fill"></i> 91-5152xxxxxx
                </span>
              </div>
            </Col>
            ...
            <Col lg="6" md="6" sm="6">
              <div className="header__top__right d-flex align-items-center justify-content-end gap-3">
                <Link to="./LoginForm" className=" d-flex align-items-center gap-1">
            ...
            <Col lg="4" md="3" sm="4">
              <div className="logo">
                <h1>
                  ...
                  <img1 src={logoimg} alt="/" widht="10px" height="60px"  className="imgg" />
                    <span>
                      <i>WHEEL</i> <br /> DEAL
                    </span>
                  </Link>
